import 'package:doctorgo_doctor/views/authentication/personal_information_second.dart';
import 'package:flutter/material.dart';

class PersonalInformationFirst extends StatefulWidget {
  @override
  _PersonalInformationFirstState createState() => _PersonalInformationFirstState();
}

enum SingingCharacter { male, female, other }

class _PersonalInformationFirstState extends State<PersonalInformationFirst> {
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      value: "B.Sc, MBBS, DDVL, MD",
                      isExpanded: true,
                      icon: Icon(Icons.arrow_drop_down),
                      onChanged: (String value){

                      },
                      items: <String>["B.Sc, MBBS, DDVL, MD"]
                        .map<DropdownMenuItem<String>>((String value){
                          return DropdownMenuItem<String>(
                            value: value,
                            child: Text(value, style: TextStyle(fontWeight: FontWeight.w400),),
