...
class MakePrescriptionPage extends StatefulWidget {
  @override
  _MakePrescriptionPageState createState() => _MakePrescriptionPageState();
}

class _MakePrescriptionPageState extends State<MakePrescriptionPage> {
