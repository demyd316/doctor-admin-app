...
class AddNewProcedure extends StatefulWidget {
  @override
  _AddNewProcedureState createState() => _AddNewProcedureState();
}

class _AddNewProcedureState extends State<AddNewProcedure> {
  @override
